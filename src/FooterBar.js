...
class FooterBar extends React.Component {
    ...
    gotopage () {
        console.log("Testtt");
        //this.props.pop.navigation.navigate('Home');
    }
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'column', backgroundColor: 'grey', }}>
                <View style={{ position: 'absolute', alignSelf: 'center', backgroundColor: 'grey', width: 70, height: 70, borderRadius: 35, bottom: 35, zIndex: 10 }}>
                    <TouchableWithoutFeedback onPress={() => pop.pop.navigation.navigate('Scan')}>
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                        {/* <TouchableOpacity onPress={() => pop.pop.navigation.navigate('Home')}> */}
